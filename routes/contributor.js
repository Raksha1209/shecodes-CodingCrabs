...
router.post("/doubt", requireLogin, async (req, res) => {
  try {
    ...
    transporter.sendMail({
      from: "CodingCrabs@gmail.com", // Your email address
      to: "rakshakl1209@gmail.com", // Your email address
...
router.post("/event-form", async (req, res) => {
  try {
    ...
    const staticEmails = ["mycrabs234@gmail.com", "sahanaarcharya@gmail.com", "Runiverse123@gmail.com", "aish1209@gmail.com", "rakshhaaa456@gmail.com", "codingcoder414@gmail.com"];
    ...
    const mailOptions = {
      from: "rakshakl1209@gmail.com", // Correct the sender email
      to: staticEmails,
...
router.post("/feedback", requireLogin, async (req, res) => {
  try {
    ...
    transporter.sendMail({
      from: "CodingCrabs@gmail.com", // Your email address
      to: ["raksha2004@gmail.com", "Sahanaacharya@gmail.com", "aishwarya@gmail.com"], // Your email address
